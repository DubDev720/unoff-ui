...
- **Bind the right CSS custom properties on link button**: add the prefix `styles` to bind the variable invocation with the right properties - a new text styled as link has been added on the story
